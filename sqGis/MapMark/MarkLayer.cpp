...
void MarkLayer::activeLabeling(QgsWkbTypes::GeometryType mark_type, QString& field)
{
	...
	{
	case QgsWkbTypes::PointGeometry:
		MapLabelStyleFactory::createLabelStyle(layersettings, QStringLiteral("ºÚÌå"), 12, QColor("darkCyan"), QColor("cyan"),0.4);
	...
	case QgsWkbTypes::LineGeometry:
		...
		break;
	case QgsWkbTypes::PolygonGeometry:
		MapLabelStyleFactory::createLabelStyle(layersettings, QStringLiteral("ºÚÌå"), 12, QColor("darkCyan"));
		layersettings.placement = QgsPalLayerSettings::AroundPoint;
		break;
	}
